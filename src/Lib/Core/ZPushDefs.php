...
class ZPushDefs{
	...
	public const AUTODISCOVER_LOGIN_EMAIL = 0;
	public const AUTODISCOVER_LOGIN_NO_DOT = 1;
	public const AUTODISCOVER_LOGIN_F_NO_DOT_LAST = 2;
	public const AUTODISCOVER_LOGIN_F_DOT_LAST = 3;
